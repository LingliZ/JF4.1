...
- (UIColor*)colorFromString:(NSString*)hexStr {
    ...
    if([hexStr hasPrefix:@"GX"]) {
        hexStr = [hexStr substringFromIndex:2];
        
        NSArray *ar=[hexStr componentsSeparatedByString:@","];
        return [UIColor colorWithRed:[ar[0] floatValue]/255 green:[ar[1] floatValue]/255 blue:[ar[2] floatValue]/255 alpha:[ar[3] floatValue]];
    }
