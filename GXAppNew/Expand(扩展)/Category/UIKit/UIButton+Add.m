...
-(void)setBtn_nextControlStateDisabled
{
    self.layer.cornerRadius=5;
    self.layer.borderWidth=1;
    self.layer.borderColor=[[UIColor getColor:Color_btn_next_normal]CGColor];
    [self setBackgroundImage:ImageFromHex(@"FFFFFF") forState:UIControlStateDisabled];
    [self setTitleColor:[UIColor getColor:Color_btn_next_normal] forState:UIControlStateDisabled];
}
@end
