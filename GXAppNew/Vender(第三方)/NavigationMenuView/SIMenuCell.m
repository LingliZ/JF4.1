...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetRGBStrokeColor(ctx, 0.933f, 0.933f, 0.933f, 1.0f);
    ...
    CGContextSetRGBStrokeColor(ctx, 1.0f, 1.0f, 1.0f, 0.0f);
...
-(void) setSelect{
    self.textLabel.textColor = UIColorFromRGB(0xFF8C00);
   // self.textLabel.textColor=GXRGBColor(255.0, 107.0, 0.0);
}


-(void) setUnSelect{
    self.textLabel.textColor = UIColorFromRGB(0x4A4A4A);
