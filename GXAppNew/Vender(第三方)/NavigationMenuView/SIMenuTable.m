...
- (id)initWithFrame:(CGRect)frame items:(NSArray *)items
{
    ...
    if (self) {
        ...
        endFrame =CGRectMake(self.bounds.origin.x+WidthScale_IOS6(68), self.bounds.origin.y, self.bounds.size.width-WidthScale_IOS6(136), self.bounds.size.height);
        startFrame = endFrame;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.font = GXFONT_PingFangSC_Light(GXFitFontSize14);
