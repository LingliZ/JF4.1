...
typedef NS_ENUM(NSUInteger, ASProgressPopUpViewDirection) {
    ASProgressPopUpViewLeft = 0,
    ASProgressPopUpViewRight = 1
};
...
@property (nonatomic, assign) ASProgressPopUpViewDirection type;
