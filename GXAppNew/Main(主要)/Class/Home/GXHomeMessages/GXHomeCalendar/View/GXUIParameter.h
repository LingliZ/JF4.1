...
#ifndef GXUIParameter_h
#define GXUIParameter_h
...
#define FUll_CONTENT_HEIGHT     FUll_VIEW_HEIGHT - 64  //如果您想创建的界面不需要减去Tabbar的高度，您可以将此参数的-49去掉即可(If you don't want to subtract Tabbar' height,you can clear away '-49')
//十六进制颜色值(hex ColorRGB)
#define UIColorFromRGB(rgbValue)    [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:1.0]
#define PageBtn     100 //6s下高度40(您如果想改变上方TopTab的高度，请设置此值)(Height 40 in iphone 6s,if you wanna change TopTab's height,please set this parameter)
...
#define More5LineWidth      FUll_VIEW_WIDTH / 7.0 //超过5个标题的宽度(Width of more than five titles)
...
#define SelectBottomLineHeight      0.5 //您可以对此参数进行设置来改变下划线的高度，默认为2，若超过3，则默认为3(You can set this to change bottomline's height,default is 2,max height is 3)
