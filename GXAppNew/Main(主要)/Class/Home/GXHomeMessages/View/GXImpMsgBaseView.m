...
@implementation GXImpMsgBaseView
{
    UIView *lineBottom;
...
- (UIScrollView *)topTab {
    if (!_topTab) {
        ...
        self.selectTitleImgArray =  @[
                                      @"home_msg_mes_select",
                                      @"home_msg_comments_select",
                                      @"home_cal_select"
                                      ];
        self.unselectTitleImgArray =  @[
                                        @"home_msg_mes_unselect",
                                        @"home_msg_comments_unselect",
                                        @"home_cal_unselect"
                                        ];
        for (NSInteger i = 0; i < titlesArray.count; i++) {
            ...
            if ([titlesArray[i] isKindOfClass:[NSString class]]) {
                //[button setImagePosition:GXImagePositionLeft spacing:5];
                [button setTitle:titlesArray[i] forState:UIControlStateNormal];
                //[button setImage:[UIImage imageNamed:self.unselectTitleImgArray[i]] forState:UIControlStateNormal];
            ...
            if (i == 0 && (topTabType == 0 || topTabType == 2 || topTabType == 3)) {
                if (selectBtn) {
                    ...
                    //[button setImage:[UIImage imageNamed:self.selectTitleImgArray[i]] forState:UIControlStateNormal];
                }else {
        ...
        topTabBottomLine.backgroundColor = UIColorFromRGB(0x000000);
    ...
    if (scrollView.tag == 318) {
        ...
        for (NSInteger i = 0;  i < btnArray.count; i++) {
            if (topTabType == 0 || topTabType == 2 || topTabType == 3) {
                if (unselectBtn) {
                    ...
                    //[btnArray[i] setImage:[UIImage imageNamed:self.unselectTitleImgArray[i]] forState:UIControlStateNormal];
                }else {
        ...
        if (topTabType == 0 || topTabType == 2 || topTabType == 3) {
            if (selectBtn) {
               ...
               // [btnArray[yourPage] setImage:[UIImage imageNamed:self.selectTitleImgArray[yourPage]] forState:UIControlStateNormal];
            }else {
