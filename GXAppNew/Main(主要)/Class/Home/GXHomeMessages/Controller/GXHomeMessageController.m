...
#import "GXHomeMessageController.h"
#import "UIParameter.h"
@interface GXHomeMessageController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong)UITableView *childBaseTableView;

@end

@implementation GXHomeMessageController{
    NSString *indexTag;
