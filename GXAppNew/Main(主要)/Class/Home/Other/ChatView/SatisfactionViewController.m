...
- (void)viewDidLoad {
    ...
    self.bgView.frame = CGRectMake(0, 0, GXScreenWidth, GXScreenHeight);
...
- (UIImageView*)headImage
{
    if (_headImage == nil) {
        ...
        _headImage.frame = CGRectMake((GXScreenWidth-50)/2, 20 + 64, 50.f, 50.f);
...
- (UILabel*)nickLabel
{
    if (_nickLabel == nil) {
        ...
        _nickLabel.frame = CGRectMake(0, CGRectGetMaxY(_headImage.frame) + kViewSpace, GXScreenWidth, 15.f);
...
- (UILabel*)textLabel
{
    if (_textLabel == nil) {
        ...
        _textLabel.frame = CGRectMake(0, CGRectGetMaxY(_nickLabel.frame) + kViewSpace, GXScreenWidth, 15.f);
...
- (CWStarRateView*)starRateView
{
    if (_starRateView == nil) {
        _starRateView = [[CWStarRateView alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(_textLabel.frame) + kViewSpace, GXScreenWidth - 20, 40) numberOfStars:5];
...
- (UITextView*)textView
{
    if (_textView == nil) {
        ...
        _textView.frame = CGRectMake(20, CGRectGetMaxY(_starRateView.frame) + kViewSpace, GXScreenWidth - 40, 100);
...
- (UIButton*)commitBtn
{
    if (_commitBtn == nil) {
        ...
        _commitBtn.frame = CGRectMake(20, CGRectGetMaxY(_textView.frame) + kViewSpace, GXScreenWidth - 40, 40);
