...
- (void)setEmotion:(GXEmotion *)emotion{
    ...
    if (emotion.isDelete) {
        [self setImage:[UIImage imageNamed:@"emoji_del_normal"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"emoji_del_high"] forState:UIControlStateHighlighted];
    }
}
