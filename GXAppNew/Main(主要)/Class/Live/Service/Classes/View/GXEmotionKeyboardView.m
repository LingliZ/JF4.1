...
#define baseTag 100
#define btnWidth 70
#define sendBtnClickNotify @"sendBtnClickNotify"
...
//        make.bottom.equalTo(self).offset(- toobarHeight);
    ...
    [self.pageC setValue:[UIImage imageNamed:@"pageControl_active"] forKey:@"_pageImage"];
    [self.pageC setValue:[UIImage imageNamed:@"pageControl_inactive"] forKey:@"_currentPageImage"];
